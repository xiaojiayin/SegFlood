#!/bin/bash
#SBATCH --job-name=infer_gffloodnet
#SBATCH --output=scripts/infer/infer_gffloodnet_%j.out
#SBATCH --error=scripts/infer/infer_gffloodnet_%j.err
...
CKPT="${1:-${PROJECT_ROOT}/logs/resnet50_resnet50_gffloodnet_2025-11-26_17-24-35/checkpoints/water_iou_0.9654.ckpt}"
DATA_ROOT="${2:-data/GF-FloodNet}"
OUT_DIR="${3:-scripts/infer/output/gffloodnet}"
BS="${4:-128}"
NW="${5:-8}"
